<script>
			    ...
			    <ul class="navbar-nav ml-auto">
					...
					<li class="nav-item dropdown">
					    ...
					    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
							<a class="dropdown-item" href="examhistory.php"><i class="fas fa-history"></i> Exam History</a>
	...
	<div class="nav-menu" id="nav-menu" style="width: 0px;">
		...
		<a class="nav-link" href="examhistory.php"><i class="fas fa-history"></i> Exam History</a>
